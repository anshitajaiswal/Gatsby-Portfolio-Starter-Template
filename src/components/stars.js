...
const bounceAnim2 = (startX2, startY2) => keyframes`
  ...
  50% {
    transform: translateY(calc(580px - ${startY2}px)) translateX(${50}px);
  }
  75% {
...
const bounceAnim1 = (startX, startY) => keyframes`
  ...
  25% {
    transform: translate(${50}px, ${window.innerHeight - startY}px);
  }
  50% {
    transform: translate(${window.innerWidth - startX}px, ${-50}px);
  }
  75% {
    transform: translate(${-50}px, ${80 - startY}px);
  }
`;
...
const Stars = ({ theme, toggleTheme }) => {
  ...
  for (let i = 0; i < 5; i++) {
    ...
    const startY = randomInRange(80, 580);
    const startX2 = randomInRange(0, 1320);
    const startY2 = randomInRange(80, 580);
    const startX3 = randomInRange(0, 1320);
    const startY3 = randomInRange(80, 580);
    const startX4 = randomInRange(0, 1320);
    const startY4 = randomInRange(80, 580);
    const startX5 = randomInRange(0, 1320);
    const startY5 = randomInRange(80, 580);
